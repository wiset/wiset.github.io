...
class Login {
    ...
    async set_username() {
        ...
        await this.bot.waitForSelector('session[username_or_email]');
        await this.bot.type('session[username_or_email]', this.config.twitter_username, { delay: 100 });
    }
    ...
    async set_password() {
        ...
        await this.bot.waitForSelector('session[password]');
        await this.bot.type('session[password]', this.config.twitter_password, { delay: 100 });
    }
